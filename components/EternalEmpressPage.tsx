    ...
    <div className="min-h-screen bg-[#050505] pt-20">
      ...
      <div className="border-b border-[#c9a054]/10 bg-[#c9a054]/3 py-2">
        <p className="text-center text-[7px] tracking-[0.6em] uppercase text-[#c9a054]/60">
          Imperial Sovereign Allocation — Archive III &nbsp;&middot;&nbsp; Ultra-Limited Imperial Batch &nbsp;&middot;&nbsp; Polygon Verified
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }}
            ...
            <div className="space-y-3 pb-6 border-b border-[#111]">
              <p className="text-[7px] tracking-[0.5em] uppercase text-zinc-600">Perfume &middot; For Her &middot; Imperial Sovereign</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-[7px] tracking-[0.4em] uppercase text-zinc-600">
                  Ultra-Limited Imperial Batch &middot; Polygon Verified
                </p>
              </div>
            </div>
