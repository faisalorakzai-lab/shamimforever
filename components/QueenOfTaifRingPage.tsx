            ...
            {orderResult ? (
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
                <textarea
                  ...
                  style={{ width:'100%', background:'transparent', border:`1px solid rgba(201,160,84,0.12)`, padding:'15px 20px', fontSize:11, color:'rgba(212,204,184,0.7)', outline:'none', resize:'none', fontFamily:'inherit', boxSizing:'border-box' as const }}
                  rows={3}
                />
                {walletAdded ? (
                  <div style={{ padding:'20px', border:`1px solid rgba(201,160,84,0.22)`, background:'rgba(201,160,84,0.04)', textAlign:'center' }}>
                    <p style={{ fontFamily:MONO, fontSize:9, letterSpacing:'0.42em', textTransform:'uppercase', color:'rgba(201,160,84,0.8)' }}>◆ Added to Wallet</p>
                  ...
                  <button
                    ...
                    style={{ width:'100%', background:`linear-gradient(135deg,rgba(201,160,84,0.14),rgba(201,160,84,0.05))`, border:`1px solid ${GOLD}`, color:GOLD2, padding:'20px', fontFamily:MONO, fontSize:9, letterSpacing:'0.44em', textTransform:'uppercase', cursor:'pointer', transition:'all .3s' }}>
                    ADD TO WALLET
                  </button>
                )}
              </div>
