...
const CONFIGS: Record<string, SovereignConfig> = {
  ...
  'her-legacy-vault': {
    ...
    legacyVoice: "Her Legacy Vault is the ultimate declaration. Containing all four sovereign compositions of the House of Shamim — each a masterwork of olfactory architecture — this is not merely a purchase. It is an inheritance. An archive that outlasts seasons, trends, and time.",
    ...
    nftTraits: [
      ...
      { trait: 'Privileges', value: 'Lifetime + Private Access' },
    ],
