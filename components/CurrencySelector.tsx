'use client'
  ...
  const CURRENCIES = [
    { code: 'USD', symbol: '$', flag: '\u{1F1FA}\u{1F1F8}', label: 'US Dollar' },
    { code: 'PKR', symbol: '\u20A8', flag: '\u{1F1F5}\u{1F1F0}', label: 'Pakistani Rupee' },
    { code: 'AED', symbol: '\u062F.\u0625', flag: '\u{1F1E6}\u{1F1EA}', label: 'UAE Dirham' },
    { code: 'SAR', symbol: '\uFDFC', flag: '\u{1F1F8}\u{1F1E6}', label: 'Saudi Riyal' },
    { code: 'GBP', symbol: '\u00A3', flag: '\u{1F1EC}\u{1F1E7}', label: 'British Pound' },
  ]
          ...
          <div style={{
            ...
            {CURRENCIES.map((cur, i) => (
              ...
              >
                ...
                <span style={{ flex: 1, textAlign: 'left' }}>{cur.code}</span>
                <span style={{ fontSize: 9, opacity: 0.4 }}>{cur.label}</span>
              </button>
            ))}
          </div>
        )}
