      ...
      <main className="min-h-screen bg-[#050505] text-zinc-200">
        <header className="relative overflow-hidden border-b border-[#15120f] px-5 py-28 md:px-12 md:py-40">
          ...
          <div className="relative mx-auto max-w-[1100px]">
            ...
            <h1 className="mt-7 max-w-5xl font-serif text-5xl font-light leading-[0.95] text-[#f3efe7] md:text-8xl">Beyond a House.<br /><span className="text-[#c9a054]">Into a World.</span></h1>
        ...
        <div className="mx-auto grid max-w-[1280px] gap-14 px-5 py-16 md:px-12 md:py-24 lg:grid-cols-[220px_1fr] lg:gap-20">
          <aside className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <nav className="mt-5 grid grid-cols-2 gap-x-5 gap-y-3 lg:grid-cols-1">{OUR_WORLD_CHAPTERS.map((chapter) => <a key={chapter.slug} href={'#' + chapter.slug} className="text-[9px] uppercase tracking-[0.16em] text-zinc-600 transition-colors hover:text-[#c9a054]"><span className="mr-2 text-[#c9a054]/70">{chapter.number}</span>{chapter.title}</a>)}</nav>
          ...
          <section>
            <div className="max-w-3xl border-b border-[#1b1814] pb-12">
              ...
              <h2 className="mt-4 font-serif text-3xl font-light leading-tight text-[#f3efe7] md:text-5xl">True luxury is an ecosystem.</h2>
