            ...
            <div style={{ maxWidth: 760, margin: '0 auto' }}>
              ...
              <div className="gc-reveal" style={{ border: '1px solid rgba(201,160,84,0.1)', background: '#080602' }}>
                {([
                  ...
                  { title: isJewelry ? 'House Jewelry Archive Newsletter' : isFragrance ? 'House Fragrance Archive Newsletter' : 'House Beauty Newsletter', desc: isJewelry ? 'Quarterly dispatches from the House of Shamim jewelry vault' : isFragrance ? 'Quarterly sovereign fragrance dispatches from the curation vault' : 'Quarterly sovereign dispatches from the curation vault' },
