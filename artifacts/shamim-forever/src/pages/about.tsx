    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="space-y-7 text-muted-foreground font-serif text-lg leading-relaxed">
          <motion.p variants={fadeUp} initial="hidden" whileInView="visible" custom={2} viewport={{ once: true }}>
            Shamim Forever is an avant-garde luxury house born out of eternal love and devotion. Established by Founder &amp; Chairman Malak Faisal Orakzai to immortalize the presence of Shamim—the true essence and sanctuary of his life. Every masterpiece under the Shamim Forever monogram is a tribute to her eternal grace.
          </motion.p>
          <motion.p variants={fadeUp} initial="hidden" whileInView="visible" custom={3} viewport={{ once: true }}>
            Where there is profound grief, there is also the power to build a legacy. Every whisper of our premium fragrances, every stroke of our elite cosmetics, and every glimmer of our sovereign jewelry carries her grace. Shamim Forever is a promise to the world that her name will never be forgotten; it will reign in the skies of global luxury forever.
          </motion.p>
        </div>
      ...
      <section className="bg-secondary/20 py-20 border-y border-border">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <motion.h2 variants={fadeUp} initial="hidden" whileInView="visible" custom={1} viewport={{ once: true }}
            className="text-3xl md:text-4xl font-serif text-foreground mb-10 leading-snug">Our Future Horizons</motion.h2>
          <motion.p variants={fadeUp} initial="hidden" whileInView="visible" custom={2} viewport={{ once: true }}
            className="text-muted-foreground font-serif text-lg leading-relaxed mb-16">
            Roadmap: Quarter 1 focuses on the official launch of our debut signature fragrance line (liquid embodiment of love housed in laser-engraved crystal vaults), followed by elite cosmetics and masterpiece fractionalized jewelry assets expanding into the UAE and UK markets.
          </motion.p>
          <div className="space-y-14">
            {[
              { tag: "Quarter I", title: "The Incarnation of Scent", body: "Shamim Forever officially launches its debut signature fragrance line — the liquid embodiment of eternal love, crafted from the rarest botanical oils, housed in laser-engraved crystal vaults, designed to leave an unforgettable, royal trail." },
              { tag: "Next Horizon", title: "Elite Cosmetics & Masterpiece Jewelry", body: "The empire expands into bespoke cosmetics engineered for perfection, followed by our sovereign jewelry house — creating fractionalized, high-end digital asset frameworks and physical diamond-crowned masterpieces that define destiny." },
              { tag: "Global Expansion", title: "UAE & UK Markets", body: "Shamim Forever will not remain confined within borders. Our operational matrix is structured for rapid international expansion — establishing physical flagship boutiques within the elite financial hubs of the UAE and the United Kingdom." }
            ].map((item, i) => (
