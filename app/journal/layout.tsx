...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'en_US',
    images: [{ url: 'https://shamimforever.com/founders-vision.png', width: 1200, height: 630, alt: 'Shamim Forever Journal' }],
  },
  twitter: {
  ...
  alternates: { canonical: 'https://shamimforever.com/journal' },
  robots: {
...
export default function JournalLayout({ children }: { children: ReactNode }) {
  const jsonLd = {
    ...
    url: 'https://shamimforever.com/journal',
    publisher: {
      '@type': 'Organization',
      name: 'Shamim Forever',
      url: 'https://shamimforever.com',
      logo: { '@type': 'ImageObject', url: 'https://shamimforever.com/favicon.ico' },
    },
    breadcrumb: {
      '@type': 'BreadcrumbList',
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://shamimforever.com' },
        { '@type': 'ListItem', position: 2, name: 'Journal', item: 'https://shamimforever.com/journal' },
      ],
    },
  }
  return (
