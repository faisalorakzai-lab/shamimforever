import { MetadataRoute } from 'next'
  ...
  const STATIC_PAGES = [
    ...
    { path: '/our-story',     priority: 0.75, changeFrequency: 'monthly' as const },
    { path: '/journal',       priority: 0.70, changeFrequency: 'weekly'  as const },
    { path: '/boutiques',     priority: 0.65, changeFrequency: 'monthly' as const },
    { path: '/concierge',     priority: 0.60, changeFrequency: 'monthly' as const },
    { path: '/gallery',       priority: 0.60, changeFrequency: 'weekly'  as const },
    { path: '/delivery',      priority: 0.55, changeFrequency: 'monthly' as const },
    { path: '/inner-circle',  priority: 0.55, changeFrequency: 'monthly' as const },
  ]
