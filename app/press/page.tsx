import type { Metadata } from 'next'
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      {
        '@type': 'Article',
        headline: 'Faisal Orakzai Founds Shamim Forever — Pakistan\'s First Global Luxury Digital House',
  ...
  const COVERAGE = [
    {
      ...
      headline: 'Faisal Orakzai on Shamim Forever — Building Pakistan\'s First Global Luxury Digital House',
    ...
    },
    {
      outlet: 'Y Combinator',
      type: 'Startup School',
      headline: 'Faisal Orakzai in Y Combinator\'s Co-Founder Matching Program',
      excerpt: 'Featured in Y Combinator\'s Startup School — connecting Shamim Forever and Orakzai Bond with global technical co-founders and early-stage investors in Silicon Valley\'s most respected accelerator ecosystem.',
    ...
    },
    {
      ...
      excerpt: 'Verified Crunchbase profile for Shamim Forever documenting its founding, focus on blockchain-verified luxury goods, and its Pakistan headquarters under founder Faisal Orakzai.',
    ...
    },
    {
      ...
      excerpt: 'Shamim Forever\'s founder maintains an ORCID academic profile (0009-0000-0915-7272) with 67+ indexed citations — bridging the worlds of blockchain research and luxury commerce innovation.',
    ...
    },
    {
      ...
      excerpt: 'Faisal Orakzai, founder of Shamim Forever, was recognized in NUST Pakistan\'s prestigious 50 Under 50 programme — honouring Pakistan\'s most impactful young entrepreneurs and innovators.',
      url: null,
      date: '2026',
      tag: 'Award',
    },
    {
      ...
      excerpt: 'Shamim Forever\'s organizational structure — from Faisal Orakzai (Founder Chairman) through its creative, digital, brand, and client divisions — is publicly documented on The Org for global transparency.',
      ...
      <>
        ...
        <div style={{ background: '#030303', color: '#e4e4e7', minHeight: '100vh', fontFamily: 'system-ui, sans-serif' }}>
          <style dangerouslySetInnerHTML={{ __html: `
            .sf-press-item { padding:24px 28px; border:1px solid #111; background:rgba(255,255,255,0.01); display:flex; gap:20px; align-items:flex-start; }
            @media(max-width:600px){ .sf-press-item{ flex-direction:column; gap:12px; } }
          `}} />
          ...
          <div style={{ padding:'80px 24px 52px', textAlign:'center', borderBottom:'1px solid #111' }}>
            ...
            <p style={{ color:'#71717a', fontSize:14, maxWidth:520, margin:'0 auto 28px', lineHeight:1.8 }}>
              Shamim Forever and its founder Faisal Orakzai are recognized across 24+ global platforms, academic indices, and entrepreneurship networks.
            </p>
          ...
          <section style={{ padding:'60px 24px' }}>
            <div style={{ maxWidth:860, margin:'0 auto', display:'flex', flexDirection:'column', gap:12 }}>
              {COVERAGE.map(item => (
                <div key={item.outlet} className="sf-press-item">
