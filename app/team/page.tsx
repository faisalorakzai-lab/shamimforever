import type { Metadata } from 'next'
  ...
  export const metadata: Metadata = {
    ...
    description: 'Meet the team behind Shamim Forever — the sovereign digital luxury house founded by Faisal Orakzai. Leadership structure spanning creative, digital, and brand operations.',
    alternates: { canonical: 'https://www.shamimforever.com/team' },
    openGraph: {
      title: 'Shamim Forever Team & Leadership',
      description: 'Sovereign digital luxury house — meet the leadership team under Founder Chairman Faisal Orakzai.',
    ...
    '@graph': [
      {
        ...
        employee: [
          ...
          { '@type': 'Person', name: 'Head of Creative',     jobTitle: 'Creative Director' },
          { '@type': 'Person', name: 'Head of Fragrance',    jobTitle: 'Master Perfumer & Fragrance Director' },
      ...
      <>
        ...
        <div style={{ background: '#030303', color: '#e4e4e7', minHeight: '100vh', fontFamily: 'system-ui, sans-serif' }}>
          <style dangerouslySetInnerHTML={{ __html: `
            ...
            @media(min-width:1000px){ .sf-team-grid{ grid-template-columns:repeat(2,1fr); } }
          ...
          <div style={{ padding:'80px 24px 52px', textAlign:'center', borderBottom:'1px solid #111' }}>
            ...
            <p style={{ color:'#71717a', fontSize:14, maxWidth:500, margin:'0 auto 28px', lineHeight:1.8 }}>
              Shamim Forever is led by Founder & Chairman <strong style={{ color:'#a1a1aa' }}>Faisal Orakzai</strong> — built by a global team across creative, digital, brand, and client experience.
            </p>
          ...
          <div style={{ padding:'52px 24px', display:'flex', justifyContent:'center', borderBottom:'1px solid #111' }}>
            <div style={{ textAlign:'center', padding:'28px 36px', border:'1px solid rgba(201,160,84,0.5)', background:'rgba(201,160,84,0.06)', maxWidth:320 }}>
              ...
              <p style={{ color:'#52525b', fontSize:12, margin:0 }}>Founder · Shamim Forever · Orakzai Group · Orakzai Bond</p>
