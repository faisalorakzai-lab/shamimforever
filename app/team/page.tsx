...
export const metadata: Metadata = {
  ...
  description: 'Meet the leadership team behind Shamim Forever. Founded by Faisal Orakzai, our global team spans creative, digital, brand, and client experience divisions.',
  alternates: { canonical: 'https://www.shamimforever.com/team' },
  openGraph: {
    title: 'Shamim Forever Team & Leadership',
    description: 'Sovereign digital luxury house — leadership team under Founder Chairman Faisal Orakzai.',
