...
export async function GET(req: NextRequest) {
  ...
  const products = [
    ...
    { 
      name: 'Imperial Musk', 
      slug: 'imperial-musk', 
      description: 'White musk elevated to imperial luxury. Clean, luminous, and utterly timeless. A scent worn by those who need no introduction.', 
    ...
    },
    {
      ...
      story: JSON.stringify({
        ...
        scentPyramid: {
          ...
          heart: 'Pure Kyara Incense Oil, Sacred Ritual Smoke — Deep, Opulent, Pure Spiritual Presence.',
