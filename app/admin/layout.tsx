...
import {
  ...
  BarChart3, Upload, LogOut, ChevronRight
} from 'lucide-react'
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (checking) {
    return (
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center">
        <p className="luxury-meta">Verifying Sovereign Access...</p>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex">
      {/* Sidebar */}
      <aside className="w-72 border-r border-[#1a1a1a] flex flex-col fixed top-0 left-0 bottom-0 z-40">
        {/* Logo */}
        <div className="p-8 border-b border-[#1a1a1a]">
          <Link href="/">
            <div className="flex flex-col leading-none">
              <span className="font-serif text-lg font-light tracking-[0.3em] uppercase text-zinc-100">
                Shamim
              </span>
          ...
          <p className="luxury-meta mt-4">Sovereign Executive Panel</p>
        </div>
        ...
        <div className="p-6 border-t border-[#1a1a1a]">
          {user && (
            <div className="mb-4">
              <p className="luxury-meta mb-1">Signed in as</p>
