...
export default async function ProductDetailPage({ params }: { params: { id: string } }) {
  ...
  // 3. Cosmetics products (For Her / For Him / Unisex) — full cosmetics detail page
  if (product.main_category_id === COSMETICS_CATEGORY_ID) {
    return <><ProductJsonLd product={product} /><CosmeticsProductPage product={product} /></>
  }

  // 4. Fallback — generic luxury product page (perfumes, jewelry, etc.)
