    ...
    <div style={{ background: '#030303', minHeight: '100vh', color: '#f0ece4', overflowX: 'hidden' }}>
      ...
      <section style={{ padding: 'clamp(56px,8vw,100px) 0', background: 'radial-gradient(ellipse 80% 60% at 50% 50%, #0e0903 0%, #030303 70%)', textAlign: 'center' }}>
        <motion.div {...reveal()} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 32, padding: '0 clamp(20px,4vw,40px)' }}>
          <div>
            <p style={{ fontSize: 7, letterSpacing: '0.9em', textTransform: 'uppercase', color: '#c9a054', marginBottom: 16 }}>The Vault Is Open</p>
            <h3 style={{ fontFamily: SERIF, fontSize: 'clamp(2rem,5vw,3.5rem)', fontWeight: 300, color: '#f0ece4', lineHeight: 1.1 }}>
              Enter the<br /><em>Sovereign Archive</em>
            </h3>
          </div>
          <div style={{ width: 60, height: 1, background: 'linear-gradient(90deg, transparent, #c9a054, transparent)' }} />
          <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link
              href="/shop?category=perfume&gender=him"
              style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '16px 36px', background: 'linear-gradient(135deg, #c9a054 0%, #8b6914 100%)', fontSize: 8, letterSpacing: '0.4em', textTransform: 'uppercase', color: '#030303', textDecoration: 'none', fontWeight: 600 }}
            >
              Shop All For Him
            </Link>
            <Link
              href="/collections"
              style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '16px 36px', border: '1px solid rgba(201,160,84,0.3)', fontSize: 8, letterSpacing: '0.4em', textTransform: 'uppercase', color: 'rgba(201,160,84,0.7)', textDecoration: 'none' }}
            >
              All Collections
            </Link>
          </div>
