...
export const metadata: Metadata = {
  ...
  description: "Pakistan's first global luxury digital house offering sovereign fragrances, bespoke fine jewellery, blockchain-verified couture, and premium concierge services.",
  keywords: [
